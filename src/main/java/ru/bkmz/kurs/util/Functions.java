...
public class Functions {
    ...
    /**
     * Коэффициент динамики числа занятых сотрудников позволяет увидеть динамику численного состава персонала за определенный период, оценить процесс заполнения вакансий с учетом количества увольнений за расчетный период
